                    ...
                    <div className="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link
                                    href="/register"
                                    className="nav-link btn btn-primary btn-sm text-white shadow border-0 me-3">REGISTER</Link>
                            </li>
                            <li className="nav-item">
                                <Link
                                    href="/login"
                                    className="nav-link btn btn-success btn-sm text-white shadow border-0">LOGIN</Link>
                            </li>
                        </ul>
                    </div>
                </div>
